...
@section('contenido')
    ...
    <div class="row heading-bg">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h5 class="txt-dark">Gestión de Bodegas de inventario</h5>
        </div>
        <!-- Breadcrumb -->
        ...
        <div class="col-sm-12">
            <div class="panel panel-default border-panel card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Nueva Bodega</h6>
                    </div>
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div class="form-wrap">
                            ...
                            <form method="POST" action="{{ route('inventario-bodegas.store') }}">
                                @csrf
